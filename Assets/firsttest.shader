    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                return fixed4(_node_1955.rgb,0);
            }
            ENDCG
        }
        Pass {
